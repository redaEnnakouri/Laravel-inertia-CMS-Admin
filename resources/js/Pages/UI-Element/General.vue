          ...
          <div class="card card-default color-palette-box">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-warning">
                    Warning
                  </h4>
              ...
              <div class="row">
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-indigo">
                    Indigo
                  </h4>
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-lightblue">
                    Lightblue
                  </h4>
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-purple">
                    Purple
                  </h4>
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-fuchsia">
                    Fuchsia
                  </h4>
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-maroon">
                    Maroon
                  </h4>
                ...
                <!-- /.col -->
                <div class="col-sm-4 col-md-2">
                  <h4 class="text-center bg-orange">
                    Orange
                  </h4>
              ...
              <div class="card card-default">
                ...
                <div class="card-body">
                  <div class="alert alert-danger alert-dismissible">
                    ...
                    <h5><i class="icon fas fa-ban" /> Alert!</h5>
                  ...
                  <div class="alert alert-info alert-dismissible">
                    ...
                    <h5><i class="icon fas fa-info" /> Alert!</h5>
                  ...
                  <div class="alert alert-warning alert-dismissible">
                    ...
                    <h5><i class="icon fas fa-exclamation-triangle" /> Alert!</h5>
                  ...
                  <div class="alert alert-success alert-dismissible">
                    ...
                    <h5><i class="icon fas fa-check" /> Alert!</h5>
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-body text-center">
                  <p>
                    By adding the class <code>.vertical</code> and <code>.progress-sm</code>, <code>.progress-xs</code>
                    or
